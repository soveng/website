...
assert.match(page, /class="[^"]*alumni-directory bg-black pt-8 pb-16 text-white sm:pt-10 sm:pb-20/, 'directory should leave a measured breathing gap before the grid');
